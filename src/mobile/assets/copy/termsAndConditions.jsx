...
/*eslint-disable */
const H = props => (
  <Text style={textStyles.body1Style}>{`${props.children}\n\n`}</Text>
);
const P = props => (
  <Text style={textStyles.body2Style}>{`${props.children}\n\n`}</Text>
);
/* eslint-enable */
...
export default () => (
  <Text style={{ textAlign: 'justify' }}>
    ...
    <P>
      Welcome to JumboSmash (“us”, “we”, “the App”, “the Service”, “the Team”).
    </P>
    <H>Acceptance of Terms of Use Agreement</H>
    <P>
      By accessing and using JumboSmash, you accept and agree to be bound by the
      Terms and Conditions, Privacy Policy, and Safety Tips (collectively, “the
      Agreement”). In addition, when using the Service, you shall be subject to
      any posted guidelines or rules applicable to JumboSmash. Any participation
      in JumboSmash will constitute acceptance of this agreement. If you do not
      agree to abide by the Agreement, do not use this service.
    </P>
    <P>
      We may update this Agreement and the Service periodically, for a variety
      of reasons including to reflect changes in or requirements of the law, or
      to update new features. The most recent version of this Agreement will be
      posted on the Service under Settings and also on jumbosmash.com. The most
      recent version is the version that applies. If the changes include
      material changes that affect your rights or obligations, we’ll let you
      know through the App or the email associated with your account. If you
      continue to use the Service after the changes become effective, then you
      agree to the revised Agreement. You agree that this Agreement shall
      supersede any prior agreements, and shall govern your entire relationship
      with JumboSmash.
    </P>
    <H>Eligibility</H>
    <P>
...
`}
    ...
    <P>
      Though JumboSmash strives to encourage a respectful user experience, the
      Team is not responsible for the conduct of any user on or off of the
      ...
      person. In addition, you agree to review and follow JumboSmash’s Safety
      Tips prior to using the Service. You agree that you will not provide your
    ...
    <P>
      ...
      UNDERSTAND THAT JUMBOSMASH DOES NOT CONDUCT CRIMINAL BACKGROUND CHECKS ON
      ITS USERS OR OTHERWISE INQUIRE INTO THE BACKGROUND OF ITS USERS.
      JUMBOSMASH MAKES NO REPRESENTATIONS OR WARRANTIES AS TO THE CONDUCT OF
      USERS. JUMBOSMASH RESERVES THE RIGHT TO CONDUCT – AND YOU AGREE THAT
      JUMBOSMASH MAY CONDUCT - ANY CRIMINAL BACKGROUND CHECK OR OTHER SCREENINGS
...
`}
    ...
    <P>
      By creating an account, you grant to JumboSmash a worldwide, transferable,
      sub-licensable, royalty-free, right and license to host, store, use, copy,
      and display information you upload to the Service.
    </P>
    <P>
      You agree that all information that you submit upon creation of your
      account, or any other time, collectively, “Content”, is accurate and
      truthful and you have the right to post this information on the Service.
    </P>
    <P>
      You understand and agree that we may monitor or review any Content you
      post as part of a Service. We may delete any Content, in whole or in part,
      that in our sole judgment violates this Agreement or may harm the
      reputation of the Service or the experience of other users. However, such
      Content is the sole responsibility of the user who posts it, and
      JumboSmash cannot guarantee that all Content will comply with this
      Agreement.
    </P>
    <P>
      When communicating with the Team, you agree to be respectful and kind. If
      we feel that your behavior towards anyone on our Team is at any time
      threatening or offensive, we reserve the right to immediately terminate
      your account.
    </P>
    <P>
      You agree that JumboSmash may access, preserve and disclose your account
      information and Content if required to do so by law or if we think it to
      be otherwise necessary, such as to: (i) comply with legal process; (ii)
      enforce this Agreement; (iii) respond to claims that any Content violates
...
\n• Post any sexually explicit content.
...
\n• We will not read your messages unless we have reason to believe you are violating the Agreement.`}
    ...
    <H>Disclaimers</H>
    <P>
      JUMBOSMASH PROVIDES THE SERVICE ON AN “AS IS” AND “AS AVAILABLE” BASIS AND
      ...
      SERVICE (INCLUDING ALL CONTENT CONTAINED THEREIN), INCLUDING, WITHOUT
      LIMITATION, ANY IMPLIED WARRANTIES OF SATISFACTORY QUALITY OR FITNESS FOR
      A PARTICULAR PURPOSE OR NON-INFRINGEMENT. JUMBOSMASH DOES NOT REPRESENT OR
      WARRANT THAT (A) THE SERVICE WILL BE UNINTERRUPTED, SECURE OR ERROR FREE,
      (B) ANY DEFECTS OR ERRORS IN THE SERVICE WILL BE CORRECTED, OR (C) THAT
      ANY CONTENT OR INFORMATION YOU OBTAIN ON OR THROUGH THE SERVICE WILL BE
      ACCURATE.
    </P>
    <P>
      JUMBOSMASH TAKES NO RESPONSIBILITY FOR ANY CONTENT THAT YOU OR ANOTHER
    ...
    <P>
      JUMBOSMASH DISCLAIMS AND TAKES NO RESPONSIBILITY FOR ANY CONDUCT OF YOU OR
      ANY OTHER USER, ON OR OFF THE SERVICE.
    </P>
    <H>Accuracy Warning</H>
    <P>
      JumboSmash is offered for informational purposes only; the Service shall
      not be responsible or liable for the accuracy, usefulness or availability
      of any information transmitted or made available via the site, and shall
      not be responsible or liable for any error or omissions in that
      information. Additionally, while the Team hopes that you use JumboSmash to
      connect with your classmates in your final semester of college (whatever
      “connect” may mean to you), we are not responsible for any failure to do
      so.
    </P>
    <H>Disaffiliation Statement</H>
    <P>
      JumboSmash is not affiliated, associated, authorized, endorsed by, or in
      any way officially connected with any approved university, or any of its
      subsidiaries or its affiliates.
    </P>
    <H>Intellectual Property</H>
    <P>
      The App and its original content, features, and functionality are owned by
      the Team and are protected by international laws.
    </P>
    <H>Limitation of Liability</H>
    <P>
      TO THE FULLEST EXTENT PERMITTED BY APPLICABLE LAW, IN NO EVENT SHALL
      JUMBOSMASH, ITS AFFILIATES, OR SERVICE PROVIDERS BE LIABLE FOR ANY
      INDIRECT, CONSEQUENTIAL, EXEMPLARY, INCIDENTAL, SPECIAL, PUNITIVE, OR
      ...
      INABILITY TO ACCESS OR USE THE SERVICE; (II) THE CONDUCT OR CONTENT OF
      OTHER USERS OR THIRD PARTIES ON, THROUGH OR FOLLOWING USE OF THE SERVICE;
      OR (III) UNAUTHORIZED ACCESS, USE OR ALTERATION OF YOUR CONTENT, EVEN IF
      JUMBOSMASH HAS BEEN ADVISED AT ANY TIME OF THE POSSIBILITY OF SUCH
      DAMAGES. THE LIMITATION OF LIABILITY PROVISIONS SET FORTH IN THIS SECTION
    ...
    <P>
      ...
      may result in the forfeiture and destruction of all information associated
      with your account. All provisions of this Agreement that, by their nature,
    ...
    <P>
      ...
      terms disclosed to you, contains the entire agreement between you and
      JumboSmash regarding your relationship with JumboSmash and the use of the
      Service. If any provision of this Agreement is held invalid, the remainder
      of this Agreement shall continue in full force and effect. The failure of
      JumboSmash to exercise or enforce any right or provision of this Agreement
      shall not constitute a waiver of such right or provision. You agree that
      your JumboSmash account is non-transferable and all of your rights to your
      account and its Content terminate upon your death.
    </P>
  </Text>
);
