...
export default (props: Props) => {
  ...
  if (profile === null) {
    throw new Error('Error: Navigation Param of Profile is null in Expanded Card Screen');
  }

  if (onMinimize === null) {
    throw new Error('Error: Navigation Param of OnMinimize is null in Expanded Card Screen');
  }
