...
async function main() {
  ...
  // var fs = require('fs');
  // const currentDocs = fs.readFileSync('./db/README.md').toString();
  ...
  try {
    ...
    docString += '# Database Schema\n';
    docString += '_NOTE_: this file is autogenerated using `npm run get-db-schema`\n\n';
    ...
    // fs.writeFileSync('./db/README.md', docString);
  } catch (error) {
    process.exit(1);
  }
}
