...
// Create Profile
exports.CREATE_PROFILE__SUCCESS = {
  status: 'CREATE_PROFILE__SUCCESS',
  code: 201,
};
exports.CREATE_PROFILE__PROFILE_ALREADY_CREATED = {
  status: 'CREATE_PROFILE__PROFILE_ALREADY_CREATED',
  code: 409,
};
exports.CREATE_PROFILE__INVALID_REQUEST = {
  status: 'CREATE_PROFILE__INVALID_REQUEST',
  code: 400,
};
exports.CREATE_PROFILE__PHOTO_REQUIRED = {
