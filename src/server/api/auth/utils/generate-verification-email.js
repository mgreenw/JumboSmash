                                      ...
                                      <tr>
                                        <td align="center" bgcolor="" class="outer-td" style="padding:0px 0px 0px 0px">
                                          <table border="0" cellpadding="0" cellspacing="0" class="button-css__deep-table___2OZyb wrapper-mobile" style="text-align:center">
                                            <tbody>
                                              <tr>
                                                <td align="center" bgcolor="#ff6262" class="inner-td" style="border-radius:6px;font-size:16px;text-align:center;background-color:inherit"><a href="${link}" style="color:#1188E6;text-decoration:none;background-color:#ff6262;border:1px solid #333333;border-color:#ff6262;border-radius:50px;border-width:1px;color:#ffffff;display:inline-block;font-family:Source Sans Pro,sans-serif;font-size:16px;font-weight:normal;letter-spacing:0px;line-height:16px;padding:12px 022px 12px 22px;text-align:center;text-decoration:none;" target="_blank">Open JumboSmash</a></td>
                                              </tr>
                                            </tbody>
                                          </table>
                                        </td>
